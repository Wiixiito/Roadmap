  ...
  if (parametroURL('pagina')=='tablero') {
    $('.bodyTotal').find('li.lista').removeClass('active');
    $('.bodyTotal').find('li#listaTablero').addClass('active');
  }

    if (parametroURL('pagina')=='revisiones') {
    $('.bodyTotal').find('li.lista').removeClass('active');
    $('.bodyTotal').find('li#listaRevisiones').addClass('active');
  }

    if (parametroURL('pagina')=='sprintcreacion') {
    $('.bodyTotal').find('li.lista').removeClass('active');
    $('.bodyTotal').find('li#listaSprint').addClass('active');
  }

   if (parametroURL('pagina')=='slide') {
    $('.bodyTotal').find('li.lista').removeClass('active');
    $('.bodyTotal').find('li#listaSlide').addClass('active');
  }

   if (parametroURL('pagina')=='responsable') {
    $('.bodyTotal').find('li.lista').removeClass('active');
    $('.bodyTotal').find('li#listaResponsable').addClass('active');
  }
    if (parametroURL('pagina')=='diccionario') {
    $('.bodyTotal').find('li.lista').removeClass('active');
    $('.bodyTotal').find('li#listaDiccionario').addClass('active');
  }
